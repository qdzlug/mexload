...
echo "POST TEST: Rate is $THERATE/s DURATION is $THEDURATION"
jq -ncM 'while(true; .+1) | {method: "POST", url: "https://hamburg-main.tdg.mobiledgex.net:10001/posts", body: {id: .} | @base64 }' | \
